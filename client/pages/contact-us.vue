...
useHead(() => ({
    ...
    link: [
        { rel: 'canonical', href: 'https://futuregenit.com/contact-us' },
    ],
}));
</script>
                                        ...
                                        <form @submit.prevent="submitForm" class="contact-form form-style-border">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input v-model="form.name" type="text" class="form-control" placeholder="Name" aria-label="Name" :class="{'is-invalid': errors.name}" />
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input v-model="form.email" type="email" class="form-control" placeholder="Email" aria-label="Email" :class="{'is-invalid': errors.email}" />
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input v-model="form.phone" type="text" class="form-control" id="phone" placeholder="Phone" :class="{'is-invalid': errors.phone}" />
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <textarea v-model="form.message" class="form-control" rows="6" placeholder="Message" :class="{'is-invalid': errors.message}"></textarea>
