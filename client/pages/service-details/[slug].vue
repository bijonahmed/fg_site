...
definePageMeta({
  ssr: true,
    ...
    useHead(() => ({
        ...
        link: [{
            rel: 'canonical',
            href: meta.value.canonical || window.location.href
        }, ],
    }));
</script>
    ...
    <div id="page" class="main">
        ...
        <div class="site-content">
            ...
            <div class="inner-header bg-holder"
                :style="{ backgroundImage: 'url(/frontend/images/banner/inner-header/page-header-01.jpg)' }">
                        ...
                        <div class="row justify-content-start">
                            ...
                            <div class="col-lg-12">
                                ...
                                <swiper ref="swiperRef" :slides-per-view="1" :space-between="50"
                                    :loop="true" :pagination="{ clickable: true, type: 'bullets' }"
                                    :autoplay="{ delay: 3000, disableOnInteraction: false }" @swiper="onSwiper"
                                    @slideChange="onSlideChange">

                                    <swiper-slide class="img_slider" v-for="data in sliderData" :key="data.id">

                                        <img :src="data.images" :alt="meta?.keywords" class="img-fluid slider_image">
                                ...
                                <div class="service_content text-justify" style="text-align: justify;"
