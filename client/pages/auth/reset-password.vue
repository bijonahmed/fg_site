                    ...
                    <div class="col-xl-5 col-md-5 m-auto">
                        ...
                        <form action="" class="login_form">
                            <div class="log_sec reg_sec">
                                ...
                                <input type="text" class="form-control" placeholder="Retype Password" name="repassword"
                                    required>
                                <button class="pbmit-btn">Reset</button>
                            </div>
