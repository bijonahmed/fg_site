...
const menuItems = ref([
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        label: "Manager list",
        icon: "fa-circle",
        route: "/usermanagement/user-role/manager-list",
      },
      {
        label: "Logistics Coordinator list",
        icon: "fa-circle",
        route: "/usermanagement/user-role/logistics-coordinator-list",
      },
      {
        label: "Warhouse staff list",
        icon: "fa-circle",
        route: "/usermanagement/user-role/warehouse-staff-list",
      },
      {
        label: "Customer Representative list",
        icon: "fa-circle",
        route: "/usermanagement/user-role/customer-representative-list",
      },
      {
        label: "Account Manager list",
        icon: "fa-circle",
        route: "/usermanagement/user-role/acount-manager-list",
      },
      {
        label: "Driver or Courier list",
        icon: "fa-circle",
        route: "/usermanagement/user-role/driver-list",
      },
      {
        label: "Finance or Billing list",
        icon: "fa-circle",
        route: "/usermanagement/user-role/finance-list",
      },
      {
        label: "Customer list",
        icon: "fa-circle",
  ...
  },
  {
    ...
    route: null,
    children: [
      { label: 'Order List', icon: 'fa-circle', route: '/order/orderlist' },
  ...
  },
  {
    ...
    route: null,
    children: [
      { label: 'Hub List', icon: 'fa-circle', route: '/hub/hublist' },
      { label: 'Add New Hub', icon: 'fa-circle', route: '/hub/addHub' },
  ...
  },
  {
    ...
    route: null,
    children: [
      { label: 'Salary List', icon: 'fa-circle', route: '/salaryManage/salaryList' },
      // { label: 'State', icon: 'fa-circle', route: '/address/stateList' },
      // { label: 'City', icon: 'fa-circle', route: '/address/cityList' },
  ...
  },
  {
    ...
    route: null,
    children: [
      { label: 'Country', icon: 'fa-circle', route: '/address/countryList' },
      { label: 'State', icon: 'fa-circle', route: '/address/stateList' },
      { label: 'City', icon: 'fa-circle', route: '/address/cityList' },
